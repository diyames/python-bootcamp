...
expense_1 = int (input("Enter Expense 1: "))  # Let the user enter a number
expense_2 = int (input("Enter Expense 1: "))  # Let the user enter a number
expense_3 = int (input("Enter Expense 1: "))  # Let the user enter a number
